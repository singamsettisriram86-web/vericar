...
export default function HeroSection() {
  ...
  const handleSearch = (e: React.FormEvent, customRc?: string) => {
    ...
    if (query.length < 5) {
      setErrorMsg('Enter a valid RC (e.g. AP05EN9264 or KA01AB1234)');
      return;
    }
    setErrorMsg('');
  ...
  return (
    <>
            ...
            >
              <div className="relative flex-1 flex items-center">
                ...
                <input
                  ...
                  placeholder="ENTER RC (E.G. AP05EN9264)"
      ...
      {/* Auth Modal Triggered When Inspecting Before Login */}
      <LoginModal
